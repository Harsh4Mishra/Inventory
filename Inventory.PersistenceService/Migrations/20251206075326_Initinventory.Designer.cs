...
namespace Inventory.PersistenceService.Migrations
{
    ...
    [Migration("20251206075326_Initinventory")]
            ...
            modelBuilder.Entity("Inventory.Domain.DomainObjects.UserRoleDO", b =>
                {
                    ...
                    b.ToTable("RefUserRole", "system", t =>
                        {
                            t.HasCheckConstraint("CK_user_role_RoleID_NotEmpty", "\"RoleId\" != '00000000-0000-0000-0000-000000000000'");

                            t.HasCheckConstraint("CK_user_role_UserID_NotEmpty", "\"UserId\" != '00000000-0000-0000-0000-000000000000'");
                        });
                });
