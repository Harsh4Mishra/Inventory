...
{
    public sealed class DeleteTrayCommandHandler
        : IRequestHandler<DeleteTrayCommand, Unit>
    {
        #region Fields
        ...
        public DeleteTrayCommandHandler(
        ...
        public async Task<Unit> Handle(DeleteTrayCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                aisle.DeleteTray(request.RowLocId, request.Id);
