...
{
    public class ConsumeMaterialBatchQuantityCommandHandler
        : IRequestHandler<ConsumeMaterialBatchQuantityCommand, Unit>
    {
        #region Fields
        ...
        public ConsumeMaterialBatchQuantityCommandHandler(
        ...
        public async Task<Unit> Handle(
            ConsumeMaterialBatchQuantityCommand request,
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                //3. Consume quantity
                materialBatch.ConsumeQuantity(request.ConsumedQuantity, userName);
            ...
            {
                throw new Exception($"Failed to consume material batch quantity: {ex.Message}");
            }
        }
